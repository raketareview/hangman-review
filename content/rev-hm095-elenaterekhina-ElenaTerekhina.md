...
Весь код находится в единственном методе- очень удручающе.
...
```
В данном случае такой способ реагирования на ошибку неправилен. Потому что если файл действительно будет отсутствовать, то программа будет работать очень странно:
```
