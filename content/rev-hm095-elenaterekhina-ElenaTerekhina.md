...
Единственный метод в проекте, его длина- 205 строк.  Из-за своего размера и сложности, метод абсолютно ужасен и нечитабилен.  
Не делай таких больших методов и тем более не делай программу, которая состоит из одного только метода.
...
```
Здесь должна быть другая реация на отсутствие файла со словами.  
...
**9. Счетчик инициализируй прямо в форе**
```
int i;
