...
- Избыточный контекст. Каждое слово в названии должно как-то лучше могать пониманию сути того, что делает метод. Слово "Raw" здесь ничего не добавляет к пониманию, это слово-паразит.  
