...
Игра в процедцрном стиле, выполнена в нескольких классах.
...
```
Здесь ошибочную команду программа отрабатывает как команду выйти из игры.
...
- Не сокращай названия тогда, когда это сокращение не обусловлено очень длинными названиями
```java
...
private boolean isGuessedLetter(char letter) {
  return guessedLettersSet.contains(letter);
}
```
