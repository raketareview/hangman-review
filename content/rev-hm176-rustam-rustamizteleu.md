...
+ 👍 Игра запускается. Хотя это здесь ни о чем не говорит- слова не читаются из памяти, а хранятся в памяти 
...
Не выявлены и не сделаны в виде классов менее очевидные, чем Словарь и Рендерер, классы.  
Например, нет класса "Слово".

Также в минус ООП играет то, как сделан класс Main.
