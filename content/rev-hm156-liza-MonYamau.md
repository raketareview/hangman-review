...
- В таких случаях принято использовать одинарные кавычки- с ними мороки меньше
```java
...
Напрмер, чтобы понять это условие, нужно в голове последовательно выполнить три операции:  
...
Первые две из этих операций можно объединить в один вспомогательные метод.  
