...
- Если в проекте есть класс с название `Word`, то все переменные с именем, включающим это название, должны быть экземплярами этого класса
```
public class Word {
...
**4. class UserConsoleInput implements UserInput**, консольная реализация интерфейса ввода
...
```
Из кода я не вижу отличий между методами печатания вопроса и методом печатания сообщения.

**6. class GallowsStates**
...
**9. class WordsFromFileList implements WordsList**
...
**10. class DefaultWordsList implements WordsList**
