...
Если по указанному адресу в не будет найден файл со словами, то программа аварийно вылетит и напечатает непонятные для юзера сообщения в консоль
```java
...
- Нарушение конвенции кода. Методы должны стоять ниже полей. В 
