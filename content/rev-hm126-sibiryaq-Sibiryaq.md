...
- "Всё" - слишком экзистенциальное название. Раз метод обещает вернуть использованные буквы, то так и назови переменную
```
...
- Понимаю, но в одном блокеинструкции `return` и `exit()` выглядят странно. 
