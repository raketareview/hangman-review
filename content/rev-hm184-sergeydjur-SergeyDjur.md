...
3. Всё время распечатывается по две одинаковых картинки за раз
```
type a letter
я
---------
...
Но для простой программы, в которой меню из двух пунктов, это нормально, даже если остальная часть программы написана в ООП стиле.
...
Например, получив слово "парабола", должно вернуть "********". 
