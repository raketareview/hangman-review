...
- Нарушение конвенции кода. Сначала должен располагаться публичные методы, потом- приватные и протектед.

- Неожиданное поведение, нарушение принципа наименьго удивления.
