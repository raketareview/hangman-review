...
Нельзя в методе устанавливать в методе поле класса и возвращать эти же данные через return. 
...
Но кроме этого метод увеличивает счетчик рошибок и заполняет список ошибочно введенных букв
```
...
**12. Способ определениея русской буквы- индусский код**
...
**13. Распечатка картинок хангмана- мегаиндусский код**
