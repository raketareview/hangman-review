...
- Не используй частицы "And" или "Or" в названии методов.

Это всегда или сигнал о том, что методы делают больше одного дела сразу и нарушают тем самым правило одной операции.  
...
🔹 Написать юзеру сообщение о том, что не удалось прочитать файл со словами  
...
Даже понять из кода, что в итоге распечатается- и то тяжело.
...
Вот такие конструкции нечитаемы в принципе.  
