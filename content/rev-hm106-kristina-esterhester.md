...
Проверка буквы- в чем именно заключается эта проворка? 
...
```
Используй цикл for всегда в полной записи, например for (int i = 0; i < 10; i++), либо используй другие виды циклов: foreach или while.


**7. Нарушение DRY**, магические буквы, числа, слова. Вводи константы (1)
```
...
//ИЛИ ТАК:
public void createMask(String letter) {
  //...
