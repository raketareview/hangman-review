...
**View это может быть не обязательно вывод текста только на экран.**
...
Но за формой MVC ты не вполне видишь её содержание.  
При написании программ в MVC, ее компоненты,- model, view,- собирай на уровне Main и инжекти в контроллер.
