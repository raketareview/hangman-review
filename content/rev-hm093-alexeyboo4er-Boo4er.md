...
3. Команды работают неправильно. Программа должна отработать либо команду "да", либо команду "нет".
...
Поэтому пока не разобрался с ООП, вообще не используй в своих классах статические поля, только если это не константы.
