...
Если к разработчику(тебе) то это лишняя информация- она ничего не объясняет о причинах появления бага и не имеет смысла. 
...
Посмотреть ролики Сергея по декомпозиции, начать с [Крестики-нолики в процедурном стиле](https://www.youtube.com/watch?v=PPikj1qHxrA).
