...
**6. Обращайся к char'у, а не к его номеру в таблице ASCII**
```java
...
**8. Используй поясняющие переменные**
